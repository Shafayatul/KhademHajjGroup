        ...
        <div class="col-md-6  mx-auto">
             <div class="row myborder">
                ...
                <form id="signup-form" method="post">
                    ...
                    <div class="input-group margin-bottom-20">
                        <input required="required" size="60" maxlength="255" class="form-control" placeholder="<?php echo __('Confirm', 'khadem');?> Password" name="confirm_password" value="<?php echo $_POST['confirm_password'];?>" id="password_confirm type="password">                                    
                    </div>
